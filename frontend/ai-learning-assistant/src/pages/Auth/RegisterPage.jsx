          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900
                  placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900
                  placeholder-slate-400 test-sm font-medium transition-all duration-200 focus:outline-none
                  focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
                  placeholder="••••••••••"
                />
              </div>
            ...
            {error && (
              <div className="rounded-lg bg-red-50 border border-red-200 p-3">
                <p classeName="text-xs text-red-600 font-medium text-center">
                  {error}
                </p>
              </div>
            )}
            ...
            <button
              ...
              disabled={loading}
              className="group relative w-full h-12 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600
            ...
            >
              ...
              group-hover:translate-[100%] transition-transform duration-700"/>
            </button>
          </div>
